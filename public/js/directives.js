angular
    ...
    .directive('autocomp', function ($document, $window) {
        return {
            restrict: 'A',
            scope:{
                "autocomp" : '='
            ...
            link: function (scope, element, attr) {
                ...
                $document.bind('click', function (event) {
                    console.log(scope.autocomp);
                    scope.autocomp = [];
                });
            }
        }
    })
    .directive('genericList', function ($document, $window) {
        return {
            restrict: 'A',
            scope:{
                "genericList" : '='
            },
            template : '<a ng-reapet="genericName in genericList">{{genericName}}</a>',
            link: function (scope, element, attr) {
